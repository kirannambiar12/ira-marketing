...
type SiteSiteMetadataOrganization = {
  ...
  readonly foundingLocation: Maybe<SiteSiteMetadataOrganizationFoundingLocation>;
...
type SiteSiteMetadataOrganizationFieldSelector = {
  ...
  readonly foundingLocation: InputMaybe<SiteSiteMetadataOrganizationFoundingLocationFieldSelector>;
  readonly legalName: InputMaybe<FieldSelectorEnum>;
...
type SiteSiteMetadataOrganizationFilterInput = {
  ...
  readonly foundingLocation: InputMaybe<SiteSiteMetadataOrganizationFoundingLocationFilterInput>;
  readonly legalName: InputMaybe<StringQueryOperatorInput>;
...
type SiteSiteMetadataOrganizationFoundingLocation = {
  readonly addressCountry: Maybe<Scalars['String']>;
};

type SiteSiteMetadataOrganizationFoundingLocationFieldSelector = {
  readonly addressCountry: InputMaybe<FieldSelectorEnum>;
};

type SiteSiteMetadataOrganizationFoundingLocationFilterInput = {
  readonly addressCountry: InputMaybe<StringQueryOperatorInput>;
};

type SiteSiteMetadataOrganizationFoundingLocationSortInput = {
...
type SiteSiteMetadataOrganizationSortInput = {
  ...
  readonly foundingLocation: InputMaybe<SiteSiteMetadataOrganizationFoundingLocationSortInput>;
  readonly legalName: InputMaybe<SortOrderEnum>;
...
type SiteMetadataQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null, readonly titleTemplate: string | null, readonly description: string | null, readonly siteUrl: string | null, readonly lang: string | null, readonly locale: string | null, readonly brand: string | null, readonly twitterUsername: string | null, readonly defaultImage: string | null, readonly organization: { readonly name: string | null, readonly legalName: string | null, readonly url: string | null, readonly logo: string | null, readonly email: string | null, readonly sameAs: ReadonlyArray<string | null> | null, readonly foundingLocation: { readonly addressCountry: string | null } | null } | null } | null } | null };
